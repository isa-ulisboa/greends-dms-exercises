...
SELECT 	
  ...
  tch.Cereals as cereals_holdings,
	tc.`Dried pulses` as dried_pulses_area,
  tch.`Dried pulses` as dried_pulses_holdings,
	tc.`Flowers and ornamental plants` as flowers_area,
  tch.`Flowers and ornamental plants` as flowears_holdings,
	tc.`Fodder plants` as fodder_area,
  tch.`Fodder plants` as fodder_holdings,
	tc.`Fresh vegetables` as fresh_veg_area,
  tch.`Fresh vegetables` as fresh_veg_holdings,
	tc.`Industrial crops` as industrial_crops_area,
  tch.`Industrial crops` as industrial_crops_holdings,
	tc.`Other temporary crops` as other_temp_crops_area,
  tch.`Other temporary crops` as other_temp_crops_holdings,
	tc.Potatoes as potatoes_area,
  tch.Potatoes  as potatoes_holdings,
	tc.Sugarbeets as sugarbeets_area,
  tch.Sugarbeets  as sugarbeets_holdings,
	tc.`Temporary grasses and grazings` as grasses_area,
  tch.`Temporary grasses and grazings` as grasses_holdings,
