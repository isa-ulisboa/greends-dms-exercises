...
of the view:
```
SELECT * from permanent_crop_freg;
```
...
SELECT municipality, COUNT(freguesia) AS num_freg FROM perm_crop_freg pcf WHERE crop_name = 'Citrus plantations' GROUP BY municipality;
 ; 
```
